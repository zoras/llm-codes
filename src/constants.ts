...
export const ALLOWED_EXCEPTIONS = {
  ...
  RAILS_ORG: {
    pattern: 'https://rubyonrails.org/',
    name: 'Ruby on Rails',
    example: 'https://rubyonrails.org/doctrine',
    category: 'Ruby on Rails',
  },
  RAILS_GUIDES: {
    pattern: 'https://guides.rubyonrails.org/',
    name: 'Ruby on Rails Guides',
    example: 'https://guides.rubyonrails.org/v8.1/index.html',
    category: 'Ruby on Rails',
  },
  RAILS_EDGE_GUIDES: {
    pattern: 'https://edgeguides.rubyonrails.org/',
    name: 'Ruby on Rails Edge Guides',
    example: 'https://edgeguides.rubyonrails.org/getting_started.html',
    category: 'Ruby on Rails',
  },
  RUBYDOC: {
  ...
  SIDEKIQ: {
    pattern: 'https://sidekiq.org/',
    name: 'Sidekiq',
    example: 'https://sidekiq.org/wiki/Getting-Started',
    category: 'Ruby',
  },
  RUBOCOP: {
    pattern: 'https://docs.rubocop.org/',
    name: 'RuboCop',
    example: 'https://docs.rubocop.org/rubocop/1.82/index.html',
    category: 'Ruby',
  },
  HOTWIRE: {
    pattern: 'https://hotwired.dev/',
    name: 'Hotwire',
    example: 'https://hotwired.dev/',
    category: 'Ruby',
  },
  TURBO: {
    pattern: 'https://turbo.hotwired.dev/',
    name: 'RubyDoc',
    example: 'https://rubydoc.info/gems/minitest',
    category: 'Ruby',
  },
  STIMULUS: {
    pattern: 'https://stimulus.hotwired.dev/',
    name: 'Stimulus',
    example: 'https://stimulus.hotwired.dev/handbook/origin',
    category: 'Ruby',
  },
  NATIVE: {
    pattern: 'https://native.hotwired.dev/',
    name: 'Native',
    example: 'https://native.hotwired.dev/overview/how-it-works',
    category: 'Ruby',
  },
  HOTWIRE_TURBO: {
    pattern: 'https://hotwire.io/documentation/turbo',
    name: 'Hotwire Turbo',
    example: 'https://hotwire.io/documentation/turbo/handbook/introduction',
    category: 'Ruby',
  },
  NOKOGIRI: {
    pattern: 'https://nokogiri.org/tutorials',
    name: 'Nokogiri',
    example: 'https://nokogiri.org/tutorials/toc.html',
    category: 'Ruby',
  },
  TAURI: {
